...
local AH = wesnoth.require "~add-ons/Legend_of_the_Invincibles/ai/ai_helper_fast.lua"
local FAU = wesnoth.require "~add-ons/Legend_of_the_Invincibles/ai/ca_fast_attack_utils.lua"
